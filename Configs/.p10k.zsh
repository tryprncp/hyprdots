# Generated by Powerlevel10k configuration wizard on 2024-05-02 at 00:12 PST.
...
# slanted separators, slanted heads, blurred tails, 2 lines, solid, full frame, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%242F╰─ʕっ•ᴥ•ʔっ' # for the root ʕっ-ᴥ•ʔ︻デ══━一
